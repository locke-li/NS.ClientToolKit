/**************************************************************
 *  类名称：          GenerateLuaAssetBundleAction
 *  描述：
 *  作者：            Chico(wuyuanbing)
 *  创建时间：        2020/12/2 15:24:20
 *  最后修改人：
 *  版权所有 （C）:   CenturyGames
 **************************************************************/
...
using UnityEditor;
using UnityEngine;
using IFilter = CenturyGame.Core.Pipeline.IFilter;

namespace CenturyGame.AppBuilder.Editor.Builds.Actions.ResProcess
{
    class GenerateLuaAssetBundleAction : BaseBuildFilterAction
    {
        //--------------------------------------------------------------
        #region Fields
        //--------------------------------------------------------------
