...
namespace UnityEngine.AssetGraph
{
    ...
    public class AssetBundleBuildMap : ScriptableObject
    {
        ...
        {
            private const string PREFKEY_AB_BUILDMAP_PATH = "CenturyGame.AssetGraph.BuildMapPath";
            ...
            public static string AssetBundleBuildMapPath
            {
                get
                {
                    ...
                    {
                        return Path.Combine("Assets/CenturyGamePackageRes/AssetGraph/Cache/", "AssetBundleBuildMap.asset");
                    }
